...
public class BottomNavigationUtils {
    ...
    public static void changeImageColorFilter(final ImageView image, int fromColor, int toColor) {
    ...
    public static void changeViewBackgroundColor(final View view, int fromColor, int toColor) {
        ValueAnimator imageColorChangeAnimation = ValueAnimator.ofObject(new ArgbEvaluator(), fromColor, toColor);
        imageColorChangeAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animator) {
    ...
    public static void changeViewTopPadding(final View view, int fromPadding, int toPadding) {
    ...
    public static void changeViewLeftPadding(final View view, int fromMargin, int toMargin) {
